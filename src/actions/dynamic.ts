...
const createDynamicResourceActions = (namespace: string) => {
  ...
  const actions: DynamicResourceActions = {
    ...
    setLoadError: (id, error: any) => ({ type: types.LOAD_ERROR, id, error }),
    ...
    setCreateError: (id, error: any) => ({ type: types.CREATE_ERROR, id, error }),
    ...
    setUpdateError: (id, error: any) => ({ type: types.UPDATE_ERROR, id, error }),
    ...
    setRemoveError: (id, error: any) => ({ type: types.REMOVE_ERROR, id, error }),
